...
namespace stl{
    ...
    using _set_traits = _hash::_hashtable_traits<true, _UniqueKey, true>;

    template <typename _ValueType,
        typename _Hash = std::hash<_ValueType>,
        typename _Equal = stl::equal_to<_ValueType>,
        typename _ExtractKey = stl::_self,
        typename _TruncateHash = stl::modulus<std::size_t>,
        typename _Rehash = _hash::_prime_rehash,
        typename _Traits = _set_traits<true>,
        typename _Alloc = _alloc::allocator<_ValueType>>
    class hash_set{
        using _hashtable = _hash::_hashtable<_ValueType, _ValueType,
    ...
    public:
        ...
        hash_set(const hash_set& _ht) _YXXX_NOEXCEPT: _M_hashtable(_ht._M_hashtable){}
        template <typename InputIter>
        hash_set(InputIter _first, InputIter _last): _M_hashtable(_first, _last){}
        hash_set(std::initializer_list<value_type>&& _ilist):
            _M_hashtable(std::move(_ilist)){}
        hash_set(hash_set&& _ht) _YXXX_NOEXCEPT:_M_hashtable(std::move(_ht._M_hashtable)){}
    ...
    template <typename _ValueType,
        ...
        typename _TruncateHash = stl::modulus<std::size_t>,
        typename _Rehash = _hash::_prime_rehash,
        typename _Traits = _set_traits<false>,
        typename _Alloc = _alloc::allocator<_ValueType>>
    class hash_multiset{
        using _hashtable = _hash::_hashtable<_ValueType, _ValueType,
            _Hash, _Equal, _ExtractKey, _TruncateHash, _Rehash, _Traits, _Alloc>;
    public:
        ...
        hash_multiset(const hash_multiset& _ht) _YXXX_NOEXCEPT: _M_hashtable(_ht._M_hashtable){}
        template <typename InputIter>
        hash_multiset(InputIter _first, InputIter _last): _M_hashtable(_first, _last){}
        hash_multiset(std::initializer_list<value_type>&& _ilist):
            _M_hashtable(std::move(_ilist)){}
        hash_multiset(hash_multiset&& _ht) _YXXX_NOEXCEPT:_M_hashtable(std::move(_ht._M_hashtable)){}
